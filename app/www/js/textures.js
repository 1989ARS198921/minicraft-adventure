...
//  Все картинки рисуются на одном холсте 5×6 плиток.
...
// 20 цветок жёлтый 21 гриб     22 куст     23 факел     24 лава
// 25 кристалл    26 светокамень 27 обсидиан 28 облако   29 портал
...
export const TILES = {
  ...
  // --- Подземелье и небо: новые плитки 23-29 + псевдонимы ---
...
function makeAtlas() {
  ...
  // 23 — факел: огонёк на рукояти
  base(23, '#6B4418');
  g.fillStyle = '#FFD75E'; g.fillRect(px(23) + 8, py(23), 16, 12);
  g.fillStyle = '#FF9A3C'; g.fillRect(px(23) + 12, py(23) + 3, 8, 6);
  // 24 — лава: раскалённая оранжевая
  ...
  base(29, '#7B2FBE'); dots(29, ['#B55CF0', '#4A1A80', '#E0B0FF'], 22);
